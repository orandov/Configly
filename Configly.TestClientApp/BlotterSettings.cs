...
namespace Configly.TestClientApp
{
    public class BlotterSettings
    {
        ...
        [DisplayName("EQ Web Service Integration Url"), DefaultValue("http://www.sd-qa.com/eq/SDCorp/SDcorp.asmx")]
        ...
        [DisplayName("FX Portfolio Url"), DefaultValue("www.sd-qa.com/fx/portfolio.asp")]
